"""
Port from https://github.com/KatherLab/barspoon-transformer
"""
...
import stamp
from stamp.types import Bags, BagSizes, CoordinatesBatch
...
class LitMilClassificationMixin(lightning.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):  # pyright: ignore[reportIncompatibleMethodOverride]
        return self.step(batch, step_name="validation")
